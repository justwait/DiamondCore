...
enum Opcodes
{
    ...
    CMSG_CHAR_CREATE                                  = 0xEB3,//
    CMSG_CHAR_CUSTOMIZE                               = 0x2C34,
    CMSG_CHAR_DELETE                                  = 0xC2D,
    CMSG_CHAR_ENUM                                    = 0x146,
    ...
    CMSG_MESSAGECHAT_SAY                              = 0x67A, //
    CMSG_MESSAGECHAT_WHISPER                          = 0x306,//
    CMSG_MESSAGECHAT_YELL                             = 0xF7F,//
    ...
    CMSG_PLAYER_LOGIN                                 = 0xEBA,
    CMSG_PLAYER_LOGOUT                                = 0x5A0,
    ...
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES                 = 0x5A5,
    CMSG_READ_ITEM                                    = 0x2F16,
    CMSG_REALM_SPLIT                                  = 0x261,
    ...
    MSG_MOVE_START_BACKWARD                           = 0x37A,//
    MSG_MOVE_START_DESCEND                            = 0x3800,
    MSG_MOVE_START_FORWARD                            = 0x0FE,//
    ...
    SMSG_ADDON_INFO                                   = 0x760,//
    SMSG_ADD_RUNE_POWER                               = 0x6915,
    SMSG_AI_REACTION                                  = 0x0637,
    SMSG_ALL_ACHIEVEMENT_DATA                         = 0x618,//
    ...
    SMSG_AURA_POINTS_DEPLETED                         = 0x095,//
    SMSG_AURA_UPDATE                                  = 0x4707,
    SMSG_AURA_UPDATE_ALL                              = 0x6916,
    SMSG_AUTH_CHALLENGE                               = 0xCAF,//
    SMSG_AUTH_RESPONSE                                = 0xA15,//
    ...
    SMSG_CHAR_CREATE                                  = 0xF25,
    SMSG_CHAR_CUSTOMIZE                               = 0x4F16,
    SMSG_CHAR_DELETE                                  = 0xE44,
    SMSG_CHAR_ENUM                                    = 0x33D,
    ...
    SMSG_CLIENTCACHE_VERSION                          = 0x72D,
    ...
    SMSG_COMPRESSED_CHAR_ENUM                         = 0x33D,
    ...
    SMSG_DROP_NEW_CONNECTION                          = 0xC2F,//
    ...
    SMSG_GUILD_COMMAND_RESULT                         = 0x9FC,//
    ...
    SMSG_MESSAGECHAT                                  = 0x009,//
    SMSG_MESSAGE_BOX                                  = 0x8D1,//
    ...
    SMSG_RESET_COMPRESSION_CONTEXT                    = 0xE2F,
    SMSG_RESET_FAILED_NOTIFY                          = 0x4616,
    SMSG_RESISTLOG                                    = 0x0000,
    SMSG_RESPOND_INSPECT_ACHIEVEMENTS                 = 0x7B8,
    ...
    SMSG_SUSPEND_COMMS                                = 0x82A,
    SMSG_RESUME_COMMS                                 = 0xE2B,
    CMSG_SUSPEND_COMMS_ACK                            = -1,
    CMSG_AUTH_CONTINUED_SESSION                       = -1,
    ...
    SMSG_VOID_STORAGE_CONTENTS                        = 0xAB1,
    SMSG_VOID_STORAGE_FAILED                          = 0x83D,
    SMSG_VOID_STORAGE_TRANSFER_CHANGES                = 0x8F0,
    SMSG_VOID_TRANSFER_RESULT                         = 0x6D8,
    SMSG_WAIT_QUEUE_FINISH                            = 0x1F8,
    SMSG_WAIT_QUEUE_UPDATE                            = 0xE7C,
    SMSG_WARDEN_DATA                                  = 0x6BD,
    SMSG_WARGAME_CHECK_ENTRY                          = 0x3DA4,
    SMSG_WARGAME_REQUEST_SENT                         = 0x59B2,
    SMSG_WEATHER                                      = 0x2904,
    SMSG_WEEKLY_LAST_RESET                            = 0x50A5,
    SMSG_WEEKLY_RESET_CURRENCY                        = 0x911,
    SMSG_WEEKLY_SPELL_USAGE                           = 0x39B7,
    SMSG_WEEKLY_SPELL_USAGE_UPDATE                    = 0x11B5,
    SMSG_WHO                                          = 0x6907,
    SMSG_WHOIS                                        = 0x6917,
    SMSG_WORLD_SERVER_INFO                            = 0x0D9,
